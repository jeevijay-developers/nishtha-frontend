...
const About = () => {
  ...
  return (
    <section id="about" style={{ background: "radial-gradient(ellipse at top, #DCD6F7 0%, #fff 100%)" }} className="py-20">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  ...
                  <span className="font-semibold text-[#424874]">MERN stack</span>,{' '}
                  <span className="font-semibold text-[#424874]">Java</span>,{' '}
                  <span className="font-semibold text-[#424874]">Python</span>, and{' '}
                  <span className="font-semibold text-[#424874]">game development</span>.
                </p>
                <p>
                ...
                <p>
                  As a former{' '}
                  <span className="font-semibold text-[#424874]">NCC cadet</span>{' '}
                  and current{' '}
                  <span className="font-semibold text-[#424874]">President of Junior JC at JCI Kota Surbhi</span>, 
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {highlights.map((highlight, index) => (
                  <div key={index} className="group p-4 rounded-xl bg-gradient-to-br from-[#A6B1E1]/20 to-[#424874]/20 hover:from-[#A6B1E1]/30 hover:to-[#424874]/30 transition-all duration-300 border border-[#A6B1E1]/30">
              ...
              <div className="flex flex-wrap gap-3">
                {techStack.map((tech, index) => (
                  <div key={index} className="group relative">
                    <div className="flex items-center space-x-2 px-4 py-3 bg-gradient-to-r from-[#A6B1E1]/20 to-[#424874]/20 hover:from-[#A6B1E1]/30 hover:to-[#424874]/30 rounded-xl border border-[#A6B1E1]/40 transition-all duration-300 hover:scale-105 hover:shadow-lg">
